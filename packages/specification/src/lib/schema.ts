 ...
 * @category JSON-RPC
 */
export interface JSONRPCResultResponse<TResult extends Result = Result> {
  jsonrpc: typeof JSONRPC_VERSION;
  id: RequestId;
  result: TResult;
}
...
export type ReadResourceRequestParams = ResourceRequestParams;
...
export type SubscribeRequestParams = ResourceRequestParams;
...
export type UnsubscribeRequestParams = ResourceRequestParams;
